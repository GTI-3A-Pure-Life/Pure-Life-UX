      ...
      fire: function (t, e, i) {
        ...
        if (s) {
          var r,
            ...
            u = s[t + "_idx"];
          if (s[t])
            for (h = s[t].slice(), r = 0, a = h.length; a > r; r++)
              h[r].fn.call(this, n);
  ...
  (s.addEventListener = s.on),
    ...
    (o.DomUtil = {
      ...
      addClass: function (t, e) {
        if (t.classList !== i)
          for (var n = o.Util.splitWords(e), s = 0, r = n.length; r > s; s++)
            t.classList.add(n[s]);
    ...
    (o.Map = o.Evented.extend({
      ...
      panInsideBounds: function (t, e) {
        ...
        return i.equals(n)
          ? this
          : (this.panTo(n, e), (this._enforcingBounds = !1), this);
      },
      ...
      _findEventTargets: function (t, e) {
        ...
        return (
          n.length || s || !o.DomEvent._isExternalTarget(r, t) || (n = [this]),
          n
        );
      },
      ...
      _limitZoom: function (t) {
        var e = this.getMinZoom(),
          i = this.getMaxZoom();
        return (
          o.Browser.any3d || (t = Math.round(t)), Math.max(e, Math.min(i, t))
        );
      },
    })),
    (o.map = function (t, e) {
        ...
        if (this._map) {
          ...
          (i = this._tiles[n]),
            i &&
              ...
              this._noTilesToLoad() &&
                ((this._loading = !1), this.fire("load")));
        }
      },
    ...
    (o.Popup = o.Layer.extend({
      ...
      _updatePosition: function () {
        if (this._map) {
          ...
          this._zoomAnimated
            ? o.DomUtil.setPosition(this._container, t)
            : (e = e.add(t));
      ...
      _project: function () {
        ...
        this._bounds.isValid() &&
          (this._pxBounds = new o.Bounds(
            this._map
              .latLngToLayerPoint(this._bounds.getSouthWest())
              ._subtract(e),
    ...
    (o.Canvas = o.Renderer.extend({
      ...
      _updatePoly: function (t, e) {
        ...
        if (a) {
          for (
            this._drawnLayers[t._leaflet_id] = t, h.beginPath(), i = 0;
            a > i;
            i++
          ) {
      ...
      _onClick: function (t) {
        var e = this._map.mouseEventToLayerPoint(t),
          i = [];
        for (var n in this._layers)
          this._layers[n]._containsPoint(e) &&
            (o.DomEvent._fakeStop(t), i.push(this._layers[n]));
        i.length && this._fireEvent(i, t);
      },
      _onMouseMove: function (t) {
        if (
          this._map &&
          !this._map.dragging._draggable._moving &&
          !this._map._animatingZoom
        ) {
          var e = this._map.mouseEventToLayerPoint(t);
        ...
        if (!this._hoveredLayer)
          for (i in this._drawnLayers)
            if (
              ...
              n.options.interactive && n._containsPoint(e))
            ) {
  ...
  (o.DomEvent = {
    ...
    _on: function (e, i, n, s) {
      ...
      return (
        o.Browser.pointer && 0 === i.indexOf("touch")
          ...
          ? "mousewheel" === i
            ? (e.addEventListener("DOMMouseScroll", h, !1),
    ...
    (o.Map.Drag = o.Handler.extend({
      addHooks: function () {
        ...
        o.DomUtil.addClass(this._map._container, "leaflet-grab"),
    ...
    (o.Map.TouchZoom = o.Handler.extend({
        ...
        if (t.touches && 2 === t.touches.length && this._zooming) {
          ...
          if (
            ...
            this._center = e.unproject(
              e.project(this._pinchStartLatLng).subtract(r)
            );
          }
          if (
            e.options.bounceAtZoomLimits ||
            !(
              (this._zoom <= e.getMinZoom() && 1 > s) ||
      ...
      _onTouchEnd: function () {
        ...
        var t = this._zoom;
        (t = this._map._limitZoom(
          t - this._startZoom > 0 ? Math.ceil(t) : Math.floor(t)
        )),
